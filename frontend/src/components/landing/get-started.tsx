...
export default function GetStarted() {
    return (
        <section className="py-24 dark:bg-slate-900 bg-slate-50 text-center tracking-wide px-8">
            ...
            <p className="text-sm text-muted-foreground max-w-lg mx-auto pb-8 px-4 pt-2">Our smart matching helps you find roomates who share your lifestyle and interest.</p>
            <Button
